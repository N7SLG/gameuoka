					...
					if(M.inthewar)
						...
						if(M.z==19&&M.Village=="Mist"&&M.inthewar)
							...
							if(M.inthewar)
								M.loc=locate(6,58,20)
								M.inthewar=0
						if(M.z==19&&M.Village=="Lightning"&&M.inthewar)
							..()
						else
...
mob/owner
	verb
		...
		Villge_War()
			set category="Staff"
			warring=1
			switch(input("Which Village do you wish to send to war?", text) in list ("Leaf","Earth","Sand","Sound","Mist","Waterfall","Rain","Grass","Lightning"))
				if("Leaf")
					leafwar=1
					switch(input("Against who?", text) in list ("Earth","Sand","Sound","Mist","Waterfall","Rain","Grass","Lightning"))
						if("Earth")
						...
						if("Lightning")
							for(var/mob/E in world)
								if(E&&E.Village=="Lightning"&&E.wartoggle)
									switch(input(E,"Join your village war?", text) in list ("Yes","No"))
										if("Yes")
											E.random=rand(1,5)
											if(E.random==1)
				...
				if("Sand")
					sandwar=1
					switch(input("Against who?", text) in list ("Leaf","Earth","Sound","Mist","Waterfall","Rain","Grass","Lightning"))
						if("Earth")
							for(var/mob/E in world)
								if(E&&E.Village=="Earth"&&E.wartoggle)
									switch(input(E,"Join your village war?", text) in list ("Yes","No"))
				...
				if("Sound")
					soundwar=1
					switch(input("Against who?", text) in list ("Leaf","Earth","Sand","Mist","Waterfall","Rain","Grass","Lightning"))
						if("Earth")
							for(var/mob/E in world)
								if(E&&E.Village=="Earth"&&E.wartoggle)
									switch(input(E,"Join your village war?", text) in list ("Yes","No"))
				...
				if("Earth")
					earthwar=1
					switch(input("Against who?", text) in list ("Leaf","Sound","Sand","Mist","Waterfall","Rain","Grass","Lightning"))
						if("Sound")
							for(var/mob/E in world)
								if(E&&E.Village=="Sound"&&E.wartoggle)
									switch(input(E,"Join your village war?", text) in list ("Yes","No"))
				...
				if("Rain")
					rainwar=1
					switch(input("Against who?", text) in list ("Leaf","Sound","Sand","Mist","Waterfall","Earth","Grass","Lightning"))
						if("Sound")
							for(var/mob/E in world)
								if(E&&E.Village=="Sound"&&E.wartoggle)
									switch(input(E,"Join your village war?", text) in list ("Yes","No"))
				...
				if("Mist")
					mistwar=1
					switch(input("Against who?", text) in list ("Leaf","Sound","Sand","Lightning","Waterfall","Earth","Grass","Rain"))
						if("Sound")
							for(var/mob/E in world)
								if(E&&E.Village=="Sound"&&E.wartoggle)
									switch(input(E,"Join your village war?", text) in list ("Yes","No"))
				...
				if("Grass")
					grasswar=1
					switch(input("Against who?", text) in list ("Leaf","Sound","Sand","Lightning","Waterfall","Earth","Mist","Rain"))
						if("Sound")
							for(var/mob/E in world)
								if(E&&E.Village=="Sound"&&E.wartoggle)
									switch(input(E,"Join your village war?", text) in list ("Yes","No"))
				...
				if("Waterfall")
					waterfallwar=1
					switch(input("Against who?", text) in list ("Leaf","Sound","Sand","Lightning","Grass","Earth","Mist","Rain"))
						if("Sound")
							for(var/mob/E in world)
								if(E&&E.Village=="Sound"&&E.wartoggle)
									switch(input(E,"Join your village war?", text) in list ("Yes","No"))
...
mob/Admin/verb
	...
	GiveVerb()
		...
		if(M:client)
			var/varVerblist = src.verbs +(/mob/hyuuga/verb/Byakugan)+(/mob/Lee/verb/Lotus)+(/mob/kaguyajutsu/verb/CreateBoneSword)  // youll have to add in all your other sets of verbs. soon ill figure out a list...
